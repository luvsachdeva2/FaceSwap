...
source_image = cv2.imread("photos/Source.jpeg")
source_img = source_image
source_image_grayscale = cv2.cvtColor(source_image, cv2.COLOR_BGR2GRAY)
# To show the grey scales image
# cv2.imshow("source_image",source_img_grayscale)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
destination_image = cv2.imread("photos/Target.jpeg")
destination_img = destination_image
destination_image_grayscale = cv2.cvtColor(destination_image, cv2.COLOR_BGR2GRAY)
# To show the grey scales image
# cv2.imshow("destination_image",destination_img_grayscale)
# cv2.waitKey(0)
# cv2.destroyAllWindows()
